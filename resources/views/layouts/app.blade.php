...
<html
    lang="{{ str_replace('_', '-', app()->getLocale()) }}" {{ $app = App\Models\general_settings::latest()->first() }}>
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li onclick="check_active('Contact')"><a id="Contact" data-scroll
                                                                 href="{{ url('contact') }}">Contacts</a></li>
                        @auth
                            <li><a href="/logoutuser">Logout</a>
                            </li>
                        ...
                        @auth
                            @if (auth()->user()->is_super_admin)
                                <li onclick="check_active('admin-area')"><a id="admin-area" data-scroll
                                                                            href="{{ route('admin_settings') }}">Admin
                                        Area</a></li>
                            @endif
                        @endauth
