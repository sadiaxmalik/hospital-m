        ...
        <div class="container">
            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <hr>
                    <div
                        class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded">{{ _("All  Requtested Appointments") }}</div>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <button wire:click="add_patient({{ $request->id }})" title="add as a patient"
                                            class="btn btn-outline-info btn-rounded"><i class="fas fa-plus"></i>
                                    </button>
