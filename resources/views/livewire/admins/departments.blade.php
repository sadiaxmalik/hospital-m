                    ...
                    <form accept-charset="utf-8" class="shadow rounded p-3" wire:submit.prevent="add_department()">
                        ...
                        <div class="form-group" x-data="{ isUploading: false, progress: 0 }"
                            ...
                            <div x-show="isUploading" style="width: 100%">
                                <progress class="progress-bar" role="progressbar" max="100" aria-valuenow="progress"
                        ...
                        @forelse ($departments as $department)
                            ...
                            <td class="text-right">
                                <button class="btn btn-outline-info btn-rounded"
                                        wire:click.prevent="edit({{ $department->id }})"><i class="fas fa-pen"></i>
                                </button>
                                <button class="btn btn-outline-danger btn-rounded"
                                        wire:click.prevent="delete({{ $department->id }})"><i class="fas fa-trash"></i>
                                </button>
                            </td>
                            </tr>
                        @empty
