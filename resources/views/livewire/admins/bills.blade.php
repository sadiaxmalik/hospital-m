            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <form accept-charset="utf-8" class="shadow rounded p-3" wire:submit.prevent="add_bill()">
                        <div
                            class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded">{{ __("Add New Bill") }}</div>
                        ...
                        @forelse ($bills as $bill)
                            <tr @if($bill->payed == 1) class="bg-success" @endif>
                                ...
                                <td class="text-center">
                                    <button wire:click="edit({{ $bill->id }})" class="btn btn-outline-info btn-rounded">
