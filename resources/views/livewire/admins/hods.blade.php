            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <form accept-charset="utf-8" class="shadow rounded p-3" wire:submit.prevent="add_hod()">
                        <div
                            class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded">{{ __("Add New hod") }}</div>
                    ...
                    <div
                        class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded">{{ _("All  HOD's") }}</div>
                        ...
                        @forelse ($hods as $hod)
                            <tr>
                                ...
                                <td class="text-center">
                                    <button wire:click="edit({{ $hod->id }})" class="btn btn-outline-info btn-rounded">
