            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <form accept-charset="utf-8" class="shadow rounded p-3" wire:submit.prevent="add_room()">
                        <div
                            class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded">{{ __("Add New room") }}</div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Enter Room Type" name="roomtype" wire:model.lazy="roomtype"
                    ...
                    <div
                        class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded">{{ _("All  rooms") }}</div>
                    <table class="table table-hover" style="" id="">
                        ...
                        @forelse ($rooms as $room)
                            <tr>
                                ...
                                <td class="text-right">
                                    <button wire:click="edit({{ $room->id }})" class="btn btn-outline-info btn-rounded">
