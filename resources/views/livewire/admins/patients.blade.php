            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <form accept-charset="utf-8" class="shadow rounded p-3" wire:submit.prevent="add_patient()">
                        <div
                            class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded">{{ __("Add New Patient") }}</div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="form-inline">
                                ...
                                <div class="form-check mx-3">
                                    <input class="form-check-input" wire:model="outdoor" type="radio" name="rad"
                                           id="rad2" value="outdoor">
                        ...
                        <div class="form-group" x-data="{ isUploading: false, progress: 0 }"
                            ...
                            @error('photo') <span
                                class="text-red-500 text-danger text-xs">{{ $message }}</span> @enderror <br>
                    ...
                    <hr>
                    <div
                        class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded">{{ _("All  patients") }}</div>
