            ...
            <form wire:submit.prevent="store_requested_appointment()">
                <fieldset>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            <div class="form-group">
                                <input type="text" wire:model.lazy="name" name="name" placeholder="Your Name"
                                       class="form-control"/>
                                @error('name') <span
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            <div class="form-group">
                                <input type="number" wire:model.lazy="phone" placeholder="Phone Number"
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            <div class="form-group">
                                <input type="text" wire:model.lazy="address" name="address" placeholder="Your Address"
                                       class="form-control"/>
                                @error('address') <span
                                    class="text-red-500 text-danger text-xs">{{ $message }}</span> @enderror
                            </div>
